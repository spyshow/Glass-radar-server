        ...
        client.Counts({}, function (err, xml) {
          if (machine.type === "MX4") {
            ...
            if (
              ...
              typeof xml.CountsResult.Root.Machine.Inspected === "undefined" // to check if the machine returned nothing
            ) {
                  ...
                  for (let i = 1; i < 8; i++) {
                    switch (i) {
                      case 1:
                        ...
                        break;
                      case 2:
                        sensorArray[sensorIndex - 1] = s2n(result.Inspected);
                      ...
                      case 6:
                        ...
                        break;
                      case 7:
                        sensorArray[sensorIndex - 1] = s2n(mold.attributes.id);
                        break;
                      default:
                        break;
                    }
                  ...
                  machine.sensors.sensors.map((sensor) => {
                    ...
                    for (var i = 1; i < sensor.counter.length + 1; i++) {
                      ...
                      if (moldIndex == 0) {
                        ...
                        insertQuery1 += "MX4_" + sensor.counter[i - 1].id + ","; //add the name of the sensor_counter
                      }
